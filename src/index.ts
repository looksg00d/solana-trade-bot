...
export const execute = async () => {
  ...
  const ORDER_LIFETIME_IN_SECONDS = 70;
  ...
  const marketPubkey = new PublicKey(
    // "4DoNfFBfF7UokCC2FQzriy7yHK6DY6NVdYpuekQ5pRgg" // main SOL_USCD
    "4DoNfFBfF7UokCC2FQzriy7yHK6DY6NVdYpuekQ5pRgg" // dev SOL_USCD
  );
